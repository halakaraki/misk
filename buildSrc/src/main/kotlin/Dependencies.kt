...
object Dependencies {
  ...
  val okio = "com.squareup.okio:okio:3.0.0-alpha.5"
  ...
  val wireCompiler = "com.squareup.wire:wire-compiler:4.0.0-alpha.1"
  val wireGradlePlugin = "com.squareup.wire:wire-gradle-plugin:4.0.0-alpha.1"
  val wireGrpcClient = "com.squareup.wire:wire-grpc-client:4.0.0-alpha.1"
  val wireMoshiAdapter = "com.squareup.wire:wire-moshi-adapter:4.0.0-alpha.1"
  val wireReflector = "com.squareup.wire:wire-reflector:4.0.0-alpha.1"
  val wireRuntime = "com.squareup.wire:wire-runtime:4.0.0-alpha.1"
  val wireSchema = "com.squareup.wire:wire-schema:4.0.0-alpha.1"
